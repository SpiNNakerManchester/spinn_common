...
//! \brief Create a circular buffer in an existing memory block. The buffer
//! must be at least the size of the buffer struct plus the buffer size (which
//! must be a power of 2) times the size of an element.
