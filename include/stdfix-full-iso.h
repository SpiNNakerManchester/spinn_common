...
static inline int mulir(
		...
		s015 x)
{
	return (int) ((__I64(n) * __I64(bitsr(x))) >> 15);
}
...
static inline long int mulilr(
		...
		s031 x)
{
	return (long int) ((__I64(n) * __I64(bitslr(x))) >> 31);
}
...
static inline int mulik(
		...
		s1615 x)
{
	return (int) ((__I64(n) * __I64(bitsk(x))) >> 15);
}
...
static inline long int divilr(
		...
		s031 x)
{
	return (long int) ((__I64(n) << 31) / bitslr(x));
}
...
static inline int divik(
		...
		s1615 x)
{
	return (long int) ((__I64(n) << 15) / bitsk(x));
}
...
static inline long int divilk(
		...
		s3231 x)
{
	return (long int) ((__I64(n) << 31) / bitslk(x));
}
...
static inline unsigned int muliur(
		...
		u016 x)
{
	return (unsigned int) ((__U64(n) * __U64(bitsur(x))) >> 16);
}
...
static inline unsigned int muliuk(
		...
		u1616 x)
{
	return (unsigned int) ((__U64(n) << 16) / bitsuk(x));
}
...
static inline unsigned int diviur(
		...
		u016 x)
{
	return (unsigned int) ((__U64(n) << 16) / bitsur(x));
}
