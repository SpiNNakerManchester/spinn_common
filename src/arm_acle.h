...
#ifndef __ARM_ACLE
//! This value is defined whenever the ARM C Language Extensions are available.
...
// We now define specific architecture features
...
{ return (__get_CONTROL () & __ARM_Q_FLAG); }
...
{
    register uint32_t r = __get_CONTROL () & ~(__ARM_Q_FLAG * (q & 1));
...
static_assert (false, "Attempt to use header file "arm_acle.h" for non-arm architecture");
#endif /*defined (__arm__) || defined (__thumb__)*/
#else  /*!__STRICT_ANSI__*/
static_assert (false, "Attempt to use header file "arm_acle.h" without -std=gnuXX flag");
#endif /*__STRICT_ANSI__*/
#else  /*!__GNUC__*/
static_assert (false, "Attempt to use header file "arm_acle.h" with a non-gcc compiler");
#endif /*__GNUC__*/
#endif /*__ARM_ACLE*/
